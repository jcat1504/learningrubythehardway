...
#define a function print_all, it takes a ile object as a parameter
def print_all(f)
...
#define a function print_a_line, it takes an integer parameter, and a
...
#opens the input file in read mode and assign the file object to current_file
current_file = open(input_file)

#prints a string
puts "First let's print the whole file:\n"

#call the print_all function,, giving it the current_file file object as a
#parameter. the function prints the content of the file
print_all(current_file)

#print a sentence
puts "Now let's rewind, kind of like a tape."

# call the rewind function, giving it the current_file as the parameter
#the file pointer for the current_file is moved to the BEGINNING of file
rewind(current_file)
...
#call the print_a_line function, give it the current_line variable and
#current_file as parameters. the function prints 2 and the second line of
#current_file
...
current_line = current_line + 1
# call the print a line function, giving it current_line and current_file as
#parameters. the function prints 3. and the 3rd line of current_file
print_a_line(current_line, current_file)
